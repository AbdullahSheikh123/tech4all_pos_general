...
frappe.ui.form.on("Stock Take", {
            ...
            frm.add_custom_button(__('Stock Reconciliation'),
                function () {
                    frappe.model.open_mapped_doc({
                        method: "tech4all_pos_general.tech4all_pos_general.doctype.stock_take.stock_take.make_stock_reconciliation",
                        frm: frm
                    });
	...
	onload: function (frm) {
	    ...
	    frm.set_query("item_code", "items", function() {
			return {
				query: "tech4all_pos_general.tech4all_pos_general.doctype.stock_take.stock_take.warehouse_items",
				filters:{
					// "is_stock_item": 1,
		...
		frm.set_query("warehouse", "warehouses", function() {
			return {
				query: "tech4all_pos_general.tech4all_pos_general.doctype.stock_take.stock_take.filter_branch_warehouses",
				filters:{
		...
		frm.set_query("item_groups", function () {
            ...
            return {
				query: "tech4all_pos_general.tech4all_pos_general.doctype.stock_take.stock_take.warehouse_item_groups",
                filters: {
	...
	branch: function(frm) {
		if(frm.doc.branch){
			...
			frappe.call({
				method: "tech4all_pos_general.tech4all_pos_general.doctype.stock_take.stock_take.get_branch_warehouses",
				args: {
					branch: frm.doc.branch
				},
				callback: function(r) {
...
populate_items: function(frm, warehouse){
	...
	frappe.call({
		method: "tech4all_pos_general.tech4all_pos_general.doctype.stock_take.stock_take.get_items",
		args: {
			warehouse: warehouse,
			posting_date: frm.doc.posting_date,
			posting_time: frm.doc.posting_time,
