...
def get_columns(filters):
    columns = [
        ...
        {"label": _("Gross Sales"), "fieldname": "total", "fieldtype": "Float", "width": 200, "precision": 2},  
        {"label": _("Discount"), "fieldname": "discount_amount", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("Sub Total"), "fieldname": "sub_total", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("Tax (Cash)"), "fieldname": "tax_cash", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("Tax (Credit)"), "fieldname": "tax_credit", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("Cash sales without tax"), "fieldname": "cash_without_tax", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("Credit sales without tax"), "fieldname": "credit_without_tax", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("sales without tax"), "fieldname": "sales_without_tax", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("Cash Sales"), "fieldname": "cash_sale", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("Credit Sales"), "fieldname": "credit_sale", "fieldtype": "Float", "width": 200, "precision": 2},
        {"label": _("Total Sales"), "fieldname": "grand_total", "fieldtype": "Float", "width": 200, "precision": 2},
    ]
    return columns
